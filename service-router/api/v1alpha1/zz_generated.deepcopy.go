...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceRouterStatus) DeepCopyInto(out *ServiceRouterStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceRouterStatus.
func (in *ServiceRouterStatus) DeepCopy() *ServiceRouterStatus {
	if in == nil {
		return nil
	}
	out := new(ServiceRouterStatus)
	in.DeepCopyInto(out)
	return out
}
